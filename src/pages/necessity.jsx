...
import { downloadJustification, downloadReport, getPurchases } from '../utils/api';
    ...
    <div className="container">
      ...
      <div className="main">
        <div className="mainProf">
          ...
          <div className="justification-header">Обоснование потребности в закупке</div>
          {/* <input type="text" placeholder="Введите номер документа" className="search-bar" />
          <div className="files">
            <div className="file">
              <img src="/word.png" alt="file-icon" /> Обоснование потребности в закупке №1925
            </div>
            <div className="file">
              <img src="/word.png" alt="file-icon" /> Обоснование потребности в закупке №2368
            </div>
            <div className="file">
              <img src="/word.png" alt="file-icon" /> Обоснование потребности в закупке №5734
            </div>
          </div> */}
